...
# SantanuMandal = "students" #pascal case

# santanuMandal = "students" #camel case

# santanu_mandal = "students" #snake case
...
# print(f"my name is {name} and my age is {age}")   --> my name is akarsh and my age is 23
...
# print(ord("A"))    -> ord convert char to int A TO 65 B to 66
# print(ord("B"))
...
# a = "SANTANU TEACHES INDUSTRY THINGS"
# print(len(a))
